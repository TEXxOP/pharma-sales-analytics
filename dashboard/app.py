...
# ============================================================
...
elif page == "🗺️ Territory Performance":
    ...
    try:
        ...
        # Heatmap
        st.markdown('<div class="section-header">🔥 Revenue Heatmap (Territory × Quarter)</div>', unsafe_allow_html=True)
        ...
        # Gap Analysis
        st.markdown('<div class="section-header">⚠️ Territories Below 80% Target</div>', unsafe_allow_html=True)
...
# ============================================================
    ...
    with col1:
        execute = st.button("▶️ Execute Query", type="primary")
    with col2:
        st.markdown(
            '<span style="color:#8b949e;font-size:0.8rem;">'
            '⚠️ Read-only mode: DROP, DELETE, INSERT, UPDATE, ALTER, TRUNCATE are blocked</span>',
            unsafe_allow_html=True,
        )
